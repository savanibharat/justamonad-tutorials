...
//	is immutable.
//	The result is NOT wrapped in Collections.unmodifiableList(list). A little of history. As of Java 9 List
...
//	Collectors.collectingAndThen(Collectors.toList(), Collections::unmodfiableList);
